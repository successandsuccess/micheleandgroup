...
export const StepsLayout = ({ children }: StepsLayoutProps) => {
  ...
  const activeOne = router.pathname === "/dashboard/jobs/add";
  const activeTwo = router.pathname === "/dashboard/jobs/add/step-two";
  const activeAnswers = router.pathname === "/dashboard/jobs/add/review";
  ...
  return (
    <article className="flex flex-col gap-5 lg:min-w-[82%]">
      <div className="flex flex-row gap-2 justify-between md:px-8 py-6 md:mx-20 border-b-2 border-[#8586887c] border-dashed">
        <Link href="/dashboard/jobs/add" className="!no-underline">
        ...
        <Link href="/dashboard/jobs/add/step-two" className="!no-underline">
          <div className="flex items-center sm:gap-4 gap-1 md:min-w-[100px] min-w-[50px]">
        ...
        <Link href="/dashboard/jobs/add/review" className="!no-underline">
          <div className="flex items-center sm:gap-4 gap-1 md:min-w-[100px] min-w-[50px]">
